    ...
    return (
        <div className="orders-content h-full flex flex-row p-6 gap-10">
            ...
            <div className={twMerge(
                "main-content h-full w-full px-6 py-5 border rounded-xl bg-white",
                (navigation.state === 'loading' || navigation.state === 'submitting') && 'opacity-55'
            )}>
                <Outlet />
            </div>
        </div>
                ...
                >
                    <NavLink
                        ...
                        className={({ isActive, isPending }) => twMerge(
                            ...
                            isPending && "border-orange-500 cursor-pointer pl-2 border-l-4 border-b-orange-300 text-slate-500",
                        )}
