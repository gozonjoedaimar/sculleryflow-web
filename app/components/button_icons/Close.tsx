...
export default function Close({ label = "Close", onClick, type = "button", ...props } : CloseProps)
{
    return (
        <button {...props} type={type} onClick={onClick} className={twMerge(
            ...
            "hover:bg-orange-500 hover:px-1 hover:w-fit",
            "active:bg-orange-500 active:px-1 active:w-fit",
            "focus:bg-orange-500 focus:px-1 focus:w-fit",
